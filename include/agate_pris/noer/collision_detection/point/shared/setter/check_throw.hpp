...
#ifndef AGATE_PRIS_NOER_COLLISION_DETECTION_POINT_SHARED_SETTER_CHECK_THROW_HPP
#define AGATE_PRIS_NOER_COLLISION_DETECTION_POINT_SHARED_SETTER_CHECK_THROW_HPP
...
( std::shared_ptr< Point > const& r, typename boost::geometry::coordinate_type< Point >::type const& v )
{
    ...
    throw std::invalid_argument(
        "agate_pris::noer::collision_detection::point::shared::setter::check_throw::impl "
