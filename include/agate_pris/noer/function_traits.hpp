	...
	namespace noer
	{
		namespace detail
		{
			template< typename P > struct function_pointer
			{
				...
				template< typename R, typename A, typename B, typename... Args      > static auto argument( R( * )( A, B, Args... ) ) -> std::tuple< A, B, Args... >;
				template< typename R, typename A, typename B, typename... Args      > static auto result(   R( * )( A, B, Args... ) ) -> R;
			...
			template< typename P > struct member_function_pointer
			{
				...
				template< typename R, typename C, typename A, typename B, typename... Args > static auto argument( R( C::* )( A, B, Args... )      ) -> std::tuple< A, B, Args... >;
				template< typename R, typename C, typename A, typename B, typename... Args > static auto result(   R( C::* )( A, B, Args... )      ) -> R;
				template< typename R, typename C, typename A, typename B, typename... Args > static auto argument( R( C::* )( A, B, Args... )const ) -> std::tuple< A, B, Args... >;
				template< typename R, typename C, typename A, typename B, typename... Args > static auto result(   R( C::* )( A, B, Args... )const ) -> R;
				using argument_type = decltype( argument( std::declval< P >() ) );
				using result_type   = decltype( result(   std::declval< P >() ) );
			};
