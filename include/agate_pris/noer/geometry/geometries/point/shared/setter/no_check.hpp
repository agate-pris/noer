...
#ifndef AGATE_PRIS_NOER_COLLISION_DETECTION_POINT_SHARED_SETTER_NO_CHECK_HPP
#define AGATE_PRIS_NOER_COLLISION_DETECTION_POINT_SHARED_SETTER_NO_CHECK_HPP
