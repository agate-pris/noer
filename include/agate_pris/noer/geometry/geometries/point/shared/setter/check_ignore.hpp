...
#ifndef AGATE_PRIS_NOER_GEOMETRY_GEOMETRIES_POINT_SHARED_SETTER_CHECK_IGNORE_HPP
#define AGATE_PRIS_NOER_GEOMETRY_GEOMETRIES_POINT_SHARED_SETTER_CHECK_IGNORE_HPP
