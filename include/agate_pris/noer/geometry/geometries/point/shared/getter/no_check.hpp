...
#ifndef AGATE_PRIS_NOER_GEOMETRY_GEOMETRIES_POINT_SHARED_GETTER_NO_CHECK_HPP
#define AGATE_PRIS_NOER_GEOMETRY_GEOMETRIES_POINT_SHARED_GETTER_NO_CHECK_HPP
