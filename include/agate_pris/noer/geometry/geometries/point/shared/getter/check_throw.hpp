...
#ifndef AGATE_PRIS_NOER_GEOMETRY_GEOMETRIES_POINT_SHARED_GETTER_CHECK_THROW_HPP
#define AGATE_PRIS_NOER_GEOMETRY_GEOMETRIES_POINT_SHARED_GETTER_CHECK_THROW_HPP
...
check_throw::impl( std::shared_ptr< Point > const& r )
{
    ...
    throw std::invalid_argument(
        "agate_pris::noer::geometry::model::point::shared::getter::check_throw::impl "
